    ...
    return {
        ...
        controller: function($scope, $element, $attrs) {
            ...
            $scope.dynamic = !0, $scope.loaded = !1, $scope.$watch("visible", function(newVal) {
                $scope.currentSection ? newVal && loadContent($scope.sections[$scope.currentSection.section]) : !$scope.loaded && newVal && $http.get($attrs.dynLoad).success(function(response) {
                    $scope.loaded = !0, $scope.content = $sce.trustAsHtml(response);
                });
            }), $scope.$watch("currentSection", function(newVal) {
                $scope.visible && newVal && loadContent($scope.sections[newVal.section]);
            });
        }
    };
