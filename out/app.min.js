    ...
    return {
        ...
        controller: function($scope, $element, $attrs) {
            ...
            if ("popup-section" === $element[0].tagName.toLowerCase()) {
                ...
                $popupScope._dynLoadInited || ($popupScope._dynLoadInited = !0, $popupScope.$watch("visible", function(newVal) {
                    newVal && touchSection();
            ...
            $scope.$watch("visible", function(newVal) {
                newVal && ($scope.loaded ? "function" == typeof $scope[$attrs.dynOnOpen] && $scope[$attrs.dynOnOpen]({}) : $http.get($attrs.dynLoad).success(function(response) {
                    $scope.loaded = !0, $scope.content = $sce.trustAsHtml(response), "function" == typeof $scope[$attrs.dynOnLoad] && $scope[$attrs.dynOnLoad]({
                        response: response
                    });
                }));
            }));
