...
$(document).keydown(function(e) {
...
}), actiGuide.mainModule.directive("dynLoad", function() {
    return {
        restrict: "A",
        replace: !0,
        controller: function($scope, $element) {
            $scope.dynamic = !0, $scope.$watch("visible", function(newVal) {
                console.log("visible", newVal);
            }), $scope.$watch("currentSection", function(newVal) {
                newVal && console.log("currentSection", newVal.section);
            }), console.log("dyn load", $scope), console.log($element);
        }
    };
    ...
    return {
        ...
        controller: function($scope, $element, $attrs) {
            ...
            $parentScope.sections || ($parentScope.sections = {}), $parentScope.sections[$attrs.target] = $sce.trustAsHtml($element.html());
        }
    };
