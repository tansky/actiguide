...
$(document).keydown(function(e) {
        ...
        link: function(scope, element, attrs) {
            !function(attrs) {
                element.bind("click", function() {
                    ...
                    layers.layersList.length > 0 && !layers.isInTree(this) || (popupScope.visible = !0, 
                    layers.layersList.indexOf(this) < 0 && (layers.layersList.push(this), angular.element(element).data("popupElement", popupElement)), 
                    popupScope.$apply());
                });
            }(attrs);
        }
    ...
    return {
        ...
        link: function(scope, element) {
            scope.visible = !1, element.html("").bind("click", function(e) {
                angular.element(e.target).hasClass("pop-on-click") && layers.popLastLayer();
            });
            var sections = [ "title", "container" ], collect = "";
            angular.forEach(sections, function(section) {
                scope[section] && (collect += scope[section]);
            }), element.append('<div class="popup_overflow pop-on-click"></div>'), element.append('<div class="popup_wrap"><div class="popup_inner-wrap">' + collect + "</div></div>");
        }
    };
    ...
    function updateLayers(element) {
        !isInTree(element) && !isInPopup(element) && _layers.length > 0 && !angular.element(element).hasClass("pop-on-click") && popLastLayer();
    }
    ...
    function isInPopup(element) {
        return angular.element(element).hasClass("popup_wrap") ? !0 : "HTML" !== angular.element(element).parent()[0].tagName ? isInPopup(angular.element(element).parent()) : !1;
    }
