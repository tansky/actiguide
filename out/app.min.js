...
$(document).keydown(function(e) {
    ...
    return {
        ...
        scope: !0,
        link: function(scope, element, attrs) {
            var innerWrapStyle = "", innerWrapAdditionalClasses = "";
            ...
            var sections = [ "title", "sidebar", "container" ], collect = "";
            ...
            scope.sidebar && (innerWrapAdditionalClasses += " w-sidebar"), angular.forEach(sections, function(section) {
                scope[section] && (collect += scope[section]);
            }), element.append('<div class="popup_overflow pop-on-click"></div>'), element.append('<div class="popup_wrap pop-on-click"><div class="popup_inner-wrap' + innerWrapAdditionalClasses + '" style="' + innerWrapStyle + '">' + collect + '<div class="clear-fix"></div></div>'), 
            scope.activeSection && console.log(scope.activeSection);
        }
    };
    ...
    return {
        ...
        link: function(scope, element) {
            ...
            angular.forEach($element.find("li"), function(item) {
                !$parentScope.activeSection && angular.element(item).data("section") && ($parentScope.activeSection = angular.element(item).data("section"));
            });
        }
    };
