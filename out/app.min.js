        ...
        link: function(scope, element) {
            scope.visible = !1, element.bind("click", function() {
                if (layers.isElementInLayers(this) || !(layers.getLayersList.length > 1)) {
                    ...
                    layers.updateLayers(this), clickedElementScope.visible = !0, layers.getLayersList.indexOf(this) < 0 && layers.getLayersList.push(this), 
        ...
        link: function(scope, element, attrs) {
            !function(attrs) {
                element.bind("click", function() {
                    if (layers.isElementInLayers(this) || !(layers.getLayersList.length > 1)) {
                        var popupElement = angular.element(document.getElementById(attrs.pCaller)), popupScope = popupElement.scope();
                        layers.updateLayers(this), popupScope.visible = !0, layers.getLayersList.indexOf(this) < 0 && layers.getLayersList.push(this), 
                        popupScope.$apply();
                    }
                });
            }(attrs);
