...
$(document).keydown(function(e) {
        ...
        link: function(scope, element, attrs) {
            !function(attrs) {
                element.bind("click", function() {
                    ...
                    angular.element(this).data("skipOnUpdate", !0), layers.isInTree(popupElement) || (popupScope.visible = !0, 
                    popupScope.$apply(), layers.layersList.push(popupElement));
                });
            }(attrs);
        }
    };
    ...
    function updateLayers(element) {
        !isInTree(element) && _layers.length > 0 && !angular.element(element).hasClass("pop-on-click") && !angular.element(element).data("skipOnUpdate") && popLastLayer();
    }
