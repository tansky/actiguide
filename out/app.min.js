...
$(document).keydown(function(e) {
    ...
    return {
        ...
        controller: function($scope, $element, $attrs) {
            $scope.$watch("visible", function(visible) {
                visible && "function" == typeof $scope[$attrs.onOpen] && $scope[$attrs.onOpen]();
        ...
        link: function(scope, element, attrs) {
            angular.element(element).data("popupCaller", !0), function(attrs) {
                element.bind("click", function() {
                    ...
                    layers.layersList.length > 0 && !layers.isDownInTree(this) || (angular.forEach(layers.layersList, function(item) {
                        angular.element(item).hasClass("popup") && (angular.element(item).scope().visible = !1);
                    }), scope.noScroll = !0, popupScope.visible = !0, layers.layersList.push(popupElement), 
                    angular.element(element).data("targetPopup", popupElement), popupScope.$apply());
                });
            }(attrs);
        }
    };
    ...
    function updateLayers(element) {
        _layers.length > 0 && (angular.element(element).hasClass("pop-on-click") || !angular.element(element).data("popupCaller") && (!isUpInTree(element) || !isDownInTree(element, angular.element(_layers[_layers.length - 1]))) || angular.element(element).data("popupCaller") && !isDownInTree(angular.element(element).data("targetPopup")) || angular.element(element).hasClass("dropdown_container") && !isDownInTree(element, angular.element(_layers[_layers.length - 1]))) && (angular.element(_layers[_layers.length - 1]).hasClass("popup") && (angular.element($document[0].body).scope().noScroll = !1), 
        popLastLayer());
    }
